...
dkube_metricviz_op          = components.load_component_from_file("./metricviz.yaml")
...
def d3pipeline(
    ...
    training_script='mkdir -p /opt/dkube/output/metrics; echo -en ""mse","rmse" \n 1420.32912891321,37.687254197052" >/opt/dkube/output/metrics/metrics.csv',
    tuning = json.dumps({}),
